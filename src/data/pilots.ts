...
const pilots: Pilot[] = [
  ...
  },
  {
    ...
    street_address: '7890 Redwood Way',
    zip_code: '78901',
    description:
      'Drone pilot with expertise in search and rescue missions. Emily’s experience includes locating missing persons in remote locations, using drones equipped with thermal imaging to locate heat signatures in real-time. Focused and always ready for urgent tasks.',
  ...
  },
  {
    ...
    street_address: '2345 Birch St',
    zip_code: '23456',
    description:
      'Jack is an expert drone pilot for infrastructure inspection. His experience includes inspecting bridges, dams, and other critical infrastructure, using drones to reduce risks and improve the accuracy of inspections.',
    operator_number: 'op012',
    status: 'In Flight',
  },
  {
    name: 'Kara Scott',
    phone: '345-678-9012',
    id: 'pilot13',
    email: 'kara.scott@example.com',
    street_address: '3456 Pine Ave',
    zip_code: '34567',
    description:
      'Kara has worked as a drone operator for various research projects, particularly in marine biology. Her work includes monitoring ocean life and surveying coral reefs, using drones to gather valuable data for environmental conservation.',
    operator_number: 'op013',
    status: 'Actual',
  },
  {
    name: 'Liam Harris',
  ...
  },
  {
    ...
    street_address: '9012 Redwood Blvd',
    zip_code: '90123',
    description:
      'Quinn is a drone pilot specializing in precision agriculture. By using drones for crop analysis and field monitoring, Quinn helps farmers improve crop yields and reduce operational costs, making farming practices more efficient and sustainable.',
    operator_number: 'op019',
    status: 'In Flight',
  },
  {
    name: 'Rachel King',
